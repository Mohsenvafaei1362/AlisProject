...
class Introducing_Ghole extends StatefulWidget {
  const Introducing_Ghole({Key? key}) : super(key: key);

  @override
  State<Introducing_Ghole> createState() => _Introducing_GholeState();
}

class _Introducing_GholeState extends State<Introducing_Ghole> {
  @override
  void initState() {
    super.initState();
  }
